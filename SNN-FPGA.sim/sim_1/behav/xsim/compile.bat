...
REM
REM Generated by Vivado on Sun Apr 24 17:32:01 +0530 2022
...
echo "xvlog --incr --relax -L uvm -prj neuron_sim_vlog.prj"
call xvlog  --incr --relax -L uvm -prj neuron_sim_vlog.prj -log xvlog.log
